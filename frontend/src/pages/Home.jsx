...
{/* Grid background */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-32 pb-20 text-center">
        ...
        className='text-5xl md:text-7xl font-bold leading-tight'>Build Websites with <br /> <span className='bg-linear-to-r from-purple-400 to-indigo-500 bg-clip-text text-transparent'>AI in Seconds</span></motion.h1>
